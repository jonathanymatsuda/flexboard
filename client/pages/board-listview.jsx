...
export default class BoardListView extends React.Component {
  ...
  render() {
    const noBoardTextClass = this.state.boards.length === 0
    ...
    return (
     <div className='p-8'>
            ...
            <li key={board.boardId} className="col-span-1 flex shadow-sm rounded-md">
              ...
              <div className="flex-1 flex items-center justify-between border-t border-r border-b border-gray-200 bg-white rounded-r-md truncate">
                <div className="flex-1 px-4 py-2 text-sm truncate whitespace-normal">
                  <a href={`#boardspace?boardId=${board.boardId}`} className="text-gray-900 font-medium hover:text-gray-600">
                    {board.title}
                  </a>
       ...
       <div className='text-center mt-5'>
          <h2 className={noBoardTextClass}>No boards have been created for this workspace. Click the button below to create your first one!</h2>
       </div>
